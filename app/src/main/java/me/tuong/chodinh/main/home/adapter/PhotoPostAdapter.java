...
public class PhotoPostAdapter extends PagerAdapter {

    private Context context;
    private List<PhotoSlide> photoSlides;

    public PhotoPostAdapter(Context context, List<PhotoSlide> photoSlides) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.item_slide_post,container,false);
