...
public class OnSalePresenter {
    private OnSaleInterface onSaleInterface;

    public OnSalePresenter(OnSaleInterface onSaleInterface) {
        this.onSaleInterface = onSaleInterface;
    }
    ...
    private void getPostUser(int user_id) {
        ...
        ApiService.apiService.getPost().enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(Call<List<Post>> call, Response<List<Post>> response) {
                ...
                onSaleInterface.setPost(listPost);
            }
